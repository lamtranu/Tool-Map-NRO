...
/*  53 */   private String labelText = "GIRL";
...
/*  64 */             TextField.this.mouseOver = true;
/*  65 */             TextField.this.repaint();
}
public void mouseExited(MouseEvent me) {
/*  70 */             TextField.this.mouseOver = false;
/*  71 */             TextField.this.repaint();
}
});
/*  74 */     addFocusListener(new FocusAdapter()
{
public void focusGained(FocusEvent fe) {
/*  77 */             TextField.this.showing(false);
}
public void focusLost(FocusEvent fe) {
/*  82 */             TextField.this.showing(true);
}
});
/*  85 */     TimingTargetAdapter timingTargetAdapter = new TimingTargetAdapter()
{
public void begin() {
/*  88 */           TextField.this.animateHinText = TextField.this.getText().equals("");
}
public void timingEvent(float fraction) {
/*  93 */           TextField.this.location = fraction;
/*  94 */           TextField.this.repaint();
}
};
